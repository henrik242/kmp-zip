...
// linux/mingw native). Only the random-bytes source is JS-specific.
...
internal actual fun secureRandomBytes(size: Int): ByteArray {
    ...
    while (produced < size) {
        ...
        try {
            ...
            // Translate the JS exception (a wasm trap on wasmJs) from a missing
            // or replaced Web Crypto implementation into something a Kotlin
            // caller can handle.
